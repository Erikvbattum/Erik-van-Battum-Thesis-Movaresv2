# -*- coding: utf-8 -*-
"""
Created on Tue Feb 14 14:22:03 2023
...
demand_profiles = pd.DataFrame(pd.read_excel('Input Data/Overzicht lasten en generatie.xlsx', 'profielen_bijgeschaald_2', index_col=('Uur:')))
...
pp.create_sgen(net, bus=bus_wind, p_mw=demand_profiles.at[t, 'windmolen_3_MW'], name='windmolen_1')
pp.create_sgen(net, bus=bus_wind, p_mw=demand_profiles.at[t, 'windmolen_3_MW'], name='windmolen_2')
